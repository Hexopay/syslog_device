...
module Hexopay
  ...
  class SyslogDevice < Lumberjack::Device
    SEVERITY_MAP = {
      Lumberjack::Severity::DEBUG => Syslog::LOG_DEBUG,
      Lumberjack::Severity::INFO => Syslog::LOG_INFO,
      Lumberjack::Severity::WARN => Syslog::LOG_WARNING,
      Lumberjack::Severity::ERROR => Syslog::LOG_ERR,
      Lumberjack::Severity::FATAL => Syslog::LOG_CRIT,
      Lumberjack::Severity::UNKNOWN => Syslog::LOG_ALERT
    }
